        ...
        columns: [{
            ...
            },
            {
                ...
                render: function(data, type, row) {
                    ...
                    return `
                        <button class="btn btn-sm px-3 d-flex align-items-center gap-1 shadow-sm rounded-pill ${isEnabled ? 'btn-primary text-white' : 'btn-outline-secondary'}"
                            style="font-size: 0.875rem;"
                            onclick="openStatusModal('${code}')"
                            ${isEnabled ? '' : 'disabled'}
                            title="ตรวจสอบข้อบ่งชี้และราคาตามสิทธิ์การรักษา">
                            <i class="fa fa-search-plus"></i> CHECK ข้อมูลสิทธิ์
