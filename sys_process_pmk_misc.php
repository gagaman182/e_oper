<?php
require_once("./db/connect_pmk.php"); // Oracle
include('main_top_panel_head.php');  // Header UI
?>
...
// โหลดรหัสที่มีอยู่ใน pmk_items
$.ajax({
    url: 'check_misc_exists.php',
    type: 'GET',
    dataType: 'json',
    async: false,
...
<div class="container text-start">
    <div class="mb-3">
        <h5><i class="fa fa-barcode me-2"></i> รหัส: <span class="text-primary">${d.code}</span></h5>
        <p><i class="fa fa-key me-2 text-secondary"></i> Ref Code: <strong>${d.ref_code || '-'}</strong></p>
        <p><i class="fa fa-info-circle me-2 text-warning"></i> ข้อบ่งชี้: <em>${d.indication || '-'}</em></p>
        <p><i class="fa fa-cube me-2 text-success"></i> หน่วยละ: ${d.unit || '-'}</p>
        <p><i class="fa fa-cube me-2 text-success"></i> ICD-9: ${d.icd_9_code || '-'}</p>
    </div>
    <div class="row mb-3">
        <div class="col-md-6">
    ...
    <table class="table table-sm table-bordered text-center align-middle">
        ...
        <tbody>
            ...
            <tr>
                <td class="text-start"><i class="fa fa-briefcase-medical me-1 text-info"></i> ปกส</td>
