...
<div class="container-fluid py-4">
    <div class="card p-4">
        <h4 class="mb-3 text-primary">
            <i class="fa fa-vials me-2"></i> รายการ เอ็กเรย์ (XRAY)
        </h4>
...
function clearFilters() {
    ...
    $('#labTable').DataTable().draw();
}

function exportToExcel() {
    var dt = $('#labTable').DataTable();
