...
$searchSQL = "";
if ($searchValue != '') {
    $searchSQL .= " AND (UPPER(LABCODE) LIKE '%$searchValue%' OR UPPER(LABNAME) LIKE '%$searchValue%')";
}
...
$sql = "SELECT LABCODE, REF_CODE, CODE_30, LABNAME, FUND_UNIT_PRICE, COPAY_UNIT_PRICE, MIN_PRICE, MAX_PRICE
        FROM LABCODES
...
$filename = 'export_lab_' . date('Ymd_His') . '.csv';
